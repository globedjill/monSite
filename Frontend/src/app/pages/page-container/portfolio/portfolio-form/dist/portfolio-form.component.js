...
var PortfolioFormComponent = /** @class */ (function () {
    function PortfolioFormComponent(fb, router) {
        this.fb = fb;
        this.router = router;
    }
    PortfolioFormComponent.prototype.ngOnInit = function () {
    };
    PortfolioFormComponent.prototype.initForm = function () {
        this.portfolioForm = this.fb.group({
            name: [null, forms_1.Validators.required],
            liensite: [null, [forms_1.Validators.required, forms_1.Validators.pattern('')]],
            description: [null, forms_1.Validators.required],
            lienGit: [null, forms_1.Validators.pattern('')],
            image: [null]
        });
    };
    PortfolioFormComponent.prototype.onModifyPortfolio = function () { };
